...
A collection of terminal-based Python games and small applications. I created this repository to practice core Python concepts, control flow, and terminal UI formatting.
...
1. Clone this repository to your local machine:
   ```bash
   git clone https://github.com/zeysie/python-mini-projects.git
...
To run recipe recommender, you can click here: [https://recipee-recommend.streamlit.app/](https://recipee-recommend.streamlit.app/) (might be inactive)

## What I Learned

Through building these projects, I am practicing:

Handling complex conditional logic.

Managing state and complex game logic.
